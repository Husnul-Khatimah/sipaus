...
<head>
    ...
    <link rel="stylesheet" href="Permintaan.css" />
...
<body>
    <div class="sidebar" id="sidebar">
        ...
        <div class="menu">
            ...
            <a href="#" class="menu-item active "><i class="fas fa-file-alt"></i>  <span>Permintaan</span></a>
        ...
        <div class="dashboard-box">
            <table>
                ...
                <tr>
                    ...
                    <td>2 Rim</td>
                    <td>2025-05-06</td>
                    <td><button class="btn-view">Edit</button>
                    <button class="btn-hapus">Hapus</button></td>
                     <td><button class="btn-proses">Tolak</button>
                    <button class="btn-view">Setujui</button></td>
                </tr>
                <tr>
                    <td>2</td>
                    <td>adri</td>
                    ...
                    <td><button class="btn-view">Edit</button>
                    <button class="btn-hapus">Hapus</button></td>
                    <td><button class="btn-view">Detail</button>
                    </td>
                </tr>
            </table>
        </div>
